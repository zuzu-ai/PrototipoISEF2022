...
namespace CapaVista
{
	public partial class frmProducto : Form
	{
		public frmProducto()
		{
            ...
            navegador1.ObtenerCamposdeTabla(alias, "producto", "hotelSanCarlos");
            navegador1.MetodoSalirVista(this);
            navegador1.LlenarCombobox(cbxIDEmpresa, "bodega", "pkid", "nombre", "estado");
		...
		{
            navegador1.EnviarDatoComboaTextbox(cbxIDEmpresa, txtBodega);
        }

		private void txtBodega_TextChanged(object sender, EventArgs e)
		{
            navegador1.SeleccionarElementosenCombo(cbxIDEmpresa, txtBodega);
        }
